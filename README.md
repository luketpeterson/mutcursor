...
[Frank Steffahn](https://github.com/steffahn) identified soundness issues in prior versions of this crate, made vast improvements to the design of [`MutCursorRootedVec`] and implemented the [`unique`] module.
